...
→ See `../../../services/idp/index.md` and related reference pages.
...
- Delegation demo → `../../../services/idp/index.md`
- TE + RAR reference → `../../../services/idp/reference/token-exchange.md`
- Receipts → `../../../services/aria-shield/reference/receipts.md`
...
- Website page → `../../../website_copy/product_idp.md`
