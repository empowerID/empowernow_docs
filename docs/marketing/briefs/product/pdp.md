...
→ See `../../../services/pdp/index.md`.

## Proof Library

- Merge model → `../../../services/pdp/explanation/merge-model.md`
- PIP data scope → `../../../services/pdp/explanation/pip-membership.md`

## See also

- Website page → `../../../website_copy/product_pdp.md`
