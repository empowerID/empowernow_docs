...
→ See `../../../services/data-collector/index.md`.

## Proof Library

- Lineage → `../../../services/data-collector/explanation/lineage.md`
- Freshness SLAs → `../../../services/data-collector/explanation/freshness.md`

## See also

- Website page (to add) → `../../../website_copy/product_data-collector.md`
