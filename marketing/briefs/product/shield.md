...
→ See `/docs/services/aria-shield/index.md`.

## Proof Library

- Zero-token explainer → `/docs/services/aria-shield/explanation/zero-token.md`
- Budget semantics → `/docs/services/aria-shield/explanation/budgets.md`

## See also

- Website page → `/docs/website_copy/product_bff.md`
