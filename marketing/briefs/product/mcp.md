...
→ See `/docs/services/mcp-gateway/index.md` and BFF gateway technical pages.

## Proof Library

- Schema pins → `/docs/services/bff/explanation/bff_gateway_technical.md`
- Plan discipline → `/docs/services/bff/explanation/bff_gateway.md`

## See also

- Website page → `/docs/website_copy/product_gateway.md`
